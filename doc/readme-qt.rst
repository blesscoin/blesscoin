Blesscoin-Qt: Qt4 GUI for Blesscoin
===============================
...
A warning for people using the *static binary* version of Blesscoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Blesscoin is linked against libdb4.8 (see also `this Debian issue`_).
