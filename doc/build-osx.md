...
See `doc/readme-qt.rst` for instructions on building Blesscoin-Qt, the
...
A litecoind binary is not included in the Blesscoin-Qt.app bundle. You can ignore
...
on an OS X 10.6 64-bit machine fails. Official release builds of Blesscoin-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `Blesscoin-Qt.app` is easy:
...
commands:
    ...
    echo -e "rpcuser=litecoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Blesscoin/litecoin.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/Blesscoin/litecoin.conf"
